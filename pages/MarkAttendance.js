...
class MarkAttendanceScreen extends React.Component {
    constructor(props) {
...
if(this.state.players == [])
{
        ...
        console.log("PLAYERSs" + this.state.players);
        let isTaken = false;
        let shortdate = data.substring(0,5);
                ...
                return(
                    <View style={{flexDirection: 'row', height: this.state.height * 0.10, width: this.state.width *0.9, borderTopWidth: 3, borderLeftWidth: 3, borderRightWidth: 3, borderColor: 'rgb(42,39,45)'}}>
                        <Text style={{color: '#a29eaa', fontSize: 15, marginTop: this.state.height * 0.03, marginLeft: this.state.height * 0.03, paddingRight: this.state.height * 0.03, borderRightWidth: 3, borderColor: 'rgb(42,39,45)' }}>{i}</Text>
                        <Text style={{color: '#a29eaa', fontSize: 15, marginTop: this.state.height * 0.03, marginLeft: this.state.height * 0.03, marginRight: this.state.width * 0.35, borderColor: 'rgb(42,39,45)'}}>{this.state.players}</Text>    
                    </View>);
            ...
            if(isTaken == false)
            {
                ...
                <View style={{flexDirection: 'row', height: this.state.height * 0.10, width: this.state.width *0.9, borderTopWidth: 3, borderLeftWidth: 3, borderRightWidth: 3, borderColor: 'rgb(42,39,45)'}}>
                    ...
                    <Text style={{color: '#fff', fontSize: 15, marginTop: this.state.height * 0.03, marginLeft: this.state.height * 0.03, marginRight: this.state.width * 0.35, borderColor: 'rgb(42,39,45)'}}>{this.state.team}</Text>
         ...
         return(
            <BackgroundTheme>
                ...
                <View style={{alignItems: 'center', }}>
                    <Text style={{color: 'white', fontSize: 30, fontFamily: 'Open Sans'}}>Attendance</Text>
                </View>
