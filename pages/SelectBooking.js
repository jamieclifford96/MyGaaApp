...
class SelectBookingScreen extends React.Component {
    constructor(props) {
...
const times=["09:00:00","10:00:00","11:00:00","12:00:00","13:00:00","14:00:00","15:00:00","16:00:00","17:00:00","18:00:00","19:00:00","20:00:00"];
    ...
    NextPage()
    {
        ...
        if(this.state.selectedTime != "")
        {
           // alert(this.state.selectedPitch);
            this.props.navigation.navigate('MarkAttendance', data);
        }
        else
        {
    ...
    renderRow(data)
    {
       ...
       if(this.state.bookings == null)
       {
        ...
        console.log("BOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOKING" + this.state.bookings);
        let isTaken = false;
